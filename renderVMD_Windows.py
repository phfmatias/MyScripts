...
class Render():
    def __init__(self, input_file):
        ...
        self.name = self.input_file.split('.')[1].replace('\\','')
    ...
    def doRender(self):
        ...
        if self.ipt in ['gjf', 'log', 'xyz']:
            if self.wait:
                ...
                os.system('tachyon_WIN32 vmdscene.dat -format BMP -o {}.bmp -res 2000 1500 -aasamples 24'.format(self.name))
            ...
            if self.wait:
                ...
                os.system('tachyon vmdscene.dat -format BMP -o {}.bmp -res 2000 1500 -aasamples 24'.format(self.name))
            else:
                print('Rendering...')
